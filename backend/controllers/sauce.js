// Logique métiers des sauces de l'application

const Sauce = require('../models/Sauces');
const fs = require("fs");


// Créer des sauces dans la base de données

exports.createSauce = (req, res, next) => {
  const sauceObject = JSON.parse(req.body.sauce);
  delete sauceObject._id // Suppresion du faux ID envoyé par le front-end
...
// Récupération de toutes les sauces en vente
...
// Récupération d'une seule sauce en vente
